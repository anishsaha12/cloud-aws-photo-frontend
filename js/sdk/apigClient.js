...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://szhnh9lhcd.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'name'], ['body']);
